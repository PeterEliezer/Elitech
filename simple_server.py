...
class MusicHandler(BaseHTTPRequestHandler):
    ...
    def handle_upload(self):
        ...
        try:
            ...
            # Save metadata
            title = parts.get('title', [b''])[0].decode('utf-8', errors='ignore') or Path(filename).stem
            artist = parts.get('artist', [b''])[0].decode('utf-8', errors='ignore') or 'Unknown Artist'
            description = parts.get('description', [b''])[0].decode('utf-8', errors='ignore') or ''
